...
Cloud-based networking (Cloud based network architecture/configuration)

The instructor was lowkey a CCIE and needed to stamp each of our labs off manually. The last page of each writeup is his stamp.
